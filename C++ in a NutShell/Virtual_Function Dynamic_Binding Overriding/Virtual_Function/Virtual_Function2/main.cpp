...
int main()
{
	...
	//Derv1 dv1;		 //object of derived class 1
	//Derv2 dv2; 		 //object of derived class 2
	arr[0] = new Derv1; 	 //put address of dv1 in array
	arr[1] = new Derv2;   //put address of dv2 in array
 ...
 *  If the base-class destructor
 *	is not virtual then delete, like a normal member function, calls the destructor for the base class,
 *	not the destructor for the derived class. This will cause only the base part of the object to be destroyed.
 *
 * */
